...
// product model
import { create_product, delete_product, updated_product, get_all_product } from '../controller/product_controller.js'
import { admin_authentication, admin_authorization } from '../middleware/admin_auth.js'

routes.post('/create_product', upload.fields([
    { name: 'poster', maxCount: 1 },
    { name: 'images', maxCount: 10 },]), create_product)

routes.delete('/delete_product/:Adminid/:productId', admin_authorization, delete_product)
routes.delete('/updated_product/:Adminid/:productId', admin_authorization, updated_product)
routes.get('get_all_product',get_all_product)
